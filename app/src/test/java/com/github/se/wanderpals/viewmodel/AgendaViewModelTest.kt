...
class AgendaViewModelTest {
    ...
    /**
     * Test the loadStopsInfo method of the AgendaViewModel class to ensure that the stopsInfo state is updated correctly.
     */
    @Test
    fun `loadStopsInfo updates stopsInfo state`() = runTest {
        ...
        val mockStops = listOf(
            Stop(
                ...
                geoCords = GeoCords(latitude = 40.712776, longitude = -74.005974), // Example coordinates, e.g., for New York City
            ...
            Stop(
                ...
                geoCords = GeoCords(latitude = 34.052235, longitude = -118.243683), // Example coordinates, e.g., for Los Angeles

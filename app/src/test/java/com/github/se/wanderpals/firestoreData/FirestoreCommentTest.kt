...
class FirestoreCommentTest {
  ...
  fun testFromCommentConversion() {
    ...
    assertEquals(
        "14:30:00",
        firestoreComment.createdAtTime) // Verifying the correct string format of LocalTime
  }
  ...
  fun testToCommentConversion() {
    ...
    assertEquals(
        LocalTime.of(14, 30), comment.createdAtTime) // Ensure LocalTime is correctly parsed
  }
}

...
/**
 * Composable function that represents the top bar for overview screen.
 * Displays a search bar with an option to clear the search text and a menu icon for additional actions.
 *

...
/**
 * Firestore-compatible DTO for a Stop, converting LocalDate and LocalTime to String for Firestore
 * compatibility. This facilitates easy data handling between the domain model (Stop) and Firestore,
 * accommodating all necessary details including the start time and duration of the stop.
 *
...
data class FirestoreStop(
  ...
  companion object {
    /**
     * Converts a Stop model to FirestoreStop DTO, adapting LocalDate and LocalTime to String, and
     * preserving duration as an Int.
     *
  ...
  /**
   * Converts this FirestoreStop DTO back to a Stop model, parsing String to LocalDate and
   * LocalTime, while keeping duration as an Int.
   *

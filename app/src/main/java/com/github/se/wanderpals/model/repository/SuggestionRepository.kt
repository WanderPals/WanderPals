...
class SuggestionRepository(
     ...
     */
    open suspend fun getSuggestionFromTrip(tripId: String, suggestionId: String,source: Source): Suggestion? =
        ...
        withContext(dispatcher) {
            try {
                ...
                if (trip != null) {
                    ...
                    suggestionIds.mapNotNull { suggestionId -> getSuggestionFromTrip(tripId, suggestionId,source) }
                } else {

 ...
 * LocalTime to String for compatibility with Firestore's data model. Includes methods for conversion
 * between this Firestore-compatible version and the data model.
 *
...
data class FirestoreSuggestion(
    ...
    companion object {
        ...
        fun fromSuggestion(suggestion: Suggestion): FirestoreSuggestion {
            ...
            return FirestoreSuggestion(
                ...
                createdAtTime = suggestion.createdAtTime.format(timeFormatter), // Convert LocalTime to String
     ...
     *
     * @return A Suggestion object with parsed LocalDate, LocalTime fields, and converted Stop and Comment objects.
     */
    fun toSuggestion(): Suggestion {
        ...
        return Suggestion(
            ...
            userName = userName,
            text = text,
            createdAt = LocalDate.parse(createdAt, dateFormatter), // Parse date string back into LocalDate
            createdAtTime = LocalTime.parse(createdAtTime, timeFormatter), // Parse time string back into LocalTime

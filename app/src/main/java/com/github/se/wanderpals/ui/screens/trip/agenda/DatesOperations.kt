...
/**
 * Generates an array of day labels (e.g., Sun, Mon, Tue) according to the default locale.
 * These labels are used to display the days of the week in the calendar header.
 *

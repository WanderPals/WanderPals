...
/**
 * Represents a log of activities performed by users within the application.
 * Used to track user interactions and changes to various entities like trips,
 * stops, and suggestions.
 *
 ...
 * @property entityId Optional. The ID of the entity (trip, stop, suggestion, etc.) affected by the action.
 * @property entityType Optional. Type of the entity affected, helps in filtering logs by entity type.

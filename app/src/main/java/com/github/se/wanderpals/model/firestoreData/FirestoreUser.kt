...
/**
 * Firestore-compatible DTO for a User, converting Role to String and GeoCords to a compatible
 * format, ensuring that all user details are correctly handled for interactions with Firestore.
 *

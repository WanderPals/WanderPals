 ...
 * @property endDate The date on which the trip is scheduled to end. It should be the same as or
 *   after the startDate.
 * @property totalBudget The estimated or allocated budget for the entire trip. This value can help
 *   in planning and managing expenses related to the stops and activities.
 * @property description A more detailed description of the trip, which may include information
 *   about the purpose, destinations, and any specific instructions or information for the
 *   participants.
 * @property imageUrl URL for an image representing the trip, optional.
 * @property stops A list of document IDs referencing the stops sub-collection. These are the
 *   specific destinations or points of interest planned for the trip.
 * @property users A list of user IDs indicating the participants of the trip. These IDs link to the
 *   users collection to provide details about the trip's attendees.
 * @property suggestions A list of document IDs referencing the suggestions sub-collection. These
